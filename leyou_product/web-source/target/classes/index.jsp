            ...
            <div class="yui3-u Left all-sort-list">
                <div class="all-sort-list2">
                    <c:forEach items="${list}" var="cg">
                        <div class="item bo">
                            <h3><a href="">${cg.name}</a></h3>
                            <div class="item-list clearfix">
                                <div class="subitem">
                                    <c:forEach items="${cg.sublist}" var="cate1" varStatus="vs">
                                        <dl class="fore${vs.index}">
                                            <dt><a href="">${cate1.name}</a></dt>
                                            <dd>
                                                <c:forEach items="${cate1.sublist}" var="cate2">
                                                <em><a href="/search?id=${cate2.id}">${cate2.name}</a></em>
                                                </c:forEach>
                                            </dd>
                                        </dl>
                                    </c:forEach>
