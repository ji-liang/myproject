                    ...
                    <div class="cart-body">
                        <div class="cart-list">
                            <ul class="goods-list yui3-g">
                                ...
                                <li class="yui3-u-1-8"><span style="line-height:70px " class="price">${cart.price}</span></li>
                                <li class="yui3-u-1-8" style="padding-top: 20px">
                                    <a href="javascript:void(0)" class="increment mins">-</a>
                                    <input autocomplete="off" type="text" value="1" minnum="1" class="itxt" />
                                    <a href="javascript:void(0)" class="increment plus">+</a>
                                </li>
                                <li class="yui3-u-1-8"><span style="line-height:70px " class="sum">${cart.price*cart.num}</span></li>
                                <li class="yui3-u-1-8">
                                    <a href="#none">删除</a><br />
