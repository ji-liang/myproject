                ...
                <div class="goods-list">
                    <ul class="yui3-g">
                        ...
                        <li class="yui3-u-1-5">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <a href="/detail?spu_id=${spu.list.get(0).spu_id}&title=${spu.title}&price=${spu.list.get(0).price}&id=${spu.list.get(0).id}&images=${spu.list.get(0).images}" target="_blank"><img src="img/_/mobile01.png" height="200"/></a>
                                    <ul class="skus">
                                        <c:forEach items="${spu.list}" var="sku">
                                        <li class="selected"><img src="${sku.images}"></li>
                                        </c:forEach>
                                    </ul>
                                </div>
                                <div class="clearfix"></div>
                    ...
                    <div class="sui-pagination pagination-large">
                        <ul>
                            <li class="prev disabled">
                                <a href="${pageContext.request.contextPath}/search?id=${sid}&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">«上一页</a>
                            </li>
                            <c:forEach begin="1" end="5" var="p">
                            <li class="active">
                                <a href="${pageContext.request.contextPath}/search?id=${sid}&page=${p}&size=${pageInfo.pageSize}">${p}</a>
                            </li>
                            </c:forEach>
                            <li class="dotted"><span>...</span></li>
                            <li class="next">
                                <a href="${pageContext.request.contextPath}/search?id=${sid}&page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页»</a>
                            </li>
                        </ul>
